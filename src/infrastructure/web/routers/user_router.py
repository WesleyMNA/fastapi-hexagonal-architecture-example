...
from src.infrastructure.web.dtos import UserResponse
from src.infrastructure.web.mappers import UserRequestDep, UserPatchDep
from src.infrastructure.web.routers.config import UserServiceDep
